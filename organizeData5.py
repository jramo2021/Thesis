...
subclassList = ['Adenosis', 'Fibroadenoma', 'Phyllodes', 'Tubular', 'Ductal', 'Lobular', 'Mucinous', 'Papillary']
...
if not os.path.isdir(destPath):
    ...
    for sub in subclassList:
        os.makedirs(destPath + '/' + sub + '/' + 'benign' + '/')
        os.makedirs(destPath + '/' + sub + '/' + 'malignant' + '/')
    ...
    if 'adenosis' in subclass:
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Adenosis/benign/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Fibroadenoma/benign/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Phyllodes/benign/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Tubular/benign/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Ductal/malignant/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Lobular/malignant/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Mucinous/malignant/' + patients[i])
                count += 1
        ...
        for i in order:
            if count == 0:
                ...
                shutil.copytree(subclass + patients[i], destPath + '/Papillary/malignant/' + patients[i])
                count += 1